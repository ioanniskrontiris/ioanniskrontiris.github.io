...
CONNECT produced targeted, standards-facing input on trust, cybersecurity, and runtime assurance for CCAM. The project’s contributions focused on translating research results on dynamic trust assessment, zero-trust architectures, and runtime evidence into concepts consumable by existing standards bodies.
