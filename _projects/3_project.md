...
CONNECT produced targeted, standards-facing input on trust, cybersecurity, and runtime assurance for CCAM through the [CONNECT Horizon Europe project](https://horizon-connect.eu/). The project’s contributions focused on translating research results on dynamic trust assessment, zero-trust architectures, and runtime evidence into concepts consumable by existing standards bodies.

At ISO/IEC, CONNECT results were positioned primarily towards JTC 1 committees relevant to cybersecurity, privacy, and ITS. In particular, project activities fed into discussions within [ISO/IEC JTC 1/SC 27 (Information security, cybersecurity and privacy protection)](https://www.iso.org/committee/45306.html) on trust models, evidence-based assurance, and lifecycle trust concepts for complex systems-of-systems, as well as [ISO/TC 204 (Intelligent transport systems)](https://www.iso.org/committee/54706.html), where CONNECT use cases were promoted in the context of data trustworthiness and AI-supported ITS services.

At ETSI, CONNECT maintained an active presence in [ETSI TC ITS](https://www.etsi.org/committee/its) through presentations and technical exchanges, including contributions showcased at the [ETSI Security Conference](https://www.etsi.org/events/2445-etsi-security-conference-2024). These activities emphasized architectural trust anchors, runtime trust evaluation, and the interplay between security and safety in CCAM, aligning CONNECT’s Trust Assessment Framework with ongoing ETSI ITS security and trust specifications.

A key channel for pre-standardization impact was the [5G Automotive Association (5GAA)](https://5gaa.org/). CONNECT results were consolidated and communicated through 5GAA working activities, including the [Trust4CAV white paper](https://5gaa.org/creating-trust-in-connected-and-automated-vehicles/), which articulated requirements and architectural directions for trust assessment in cooperative and automated mobility. This work served as an industry-aligned vehicle for feeding CONNECT concepts downstream into formal standardization in ISO, ETSI and [3GPP SA3 (Security and Privacy)](https://www.3gpp.org/3gpp-groups/service-system-aspects-sa/sa-wg3).