...
* 5GAA (pre-standardization, WG7): Security/Privacy trust work in 5GAA with downstream feedback to SDOs (ETSI/3GPP) through contributions to concrete work items, including:
  ...
  * Efficient Security Provisioning System (ESPS) defining an optimized, privacy-preserving PKI architecture for large-scale deployments, addressing bootstrapping, certificate provisioning, trust anchor management, and revocation efficiency, with explicit alignment to ETSI ITS security standards (TS 102 940 / 102 941). [(webpage)](https://5gaa.org/5gaa-efficient-security-provisioning-system/) and [PDF](https://5gaa.org/content/uploads/2020/05/5GAA_E-200017_ESPS_White_Paper_Final33323-ed-out.pdf).
* ETSI TC ITS (trust & PKI): Alignment and architectural feedback to ETSI ITS trust and PKI concepts through 5GAA WG7 pre-standardization work, addressing trust anchor management, credential provisioning, and revocation models that informed downstream ITS security specifications within [ETSI TC ITS](https://www.etsi.org/committee/its).
* Decentralized Identity Foundation (DIF) – Wallet Security: Closely followed and evaluated the work of the [DIF Wallet Security Working Group](https://github.com/decentralized-identity/wallet-security), including the [device and holder binding work item](https://github.com/decentralized-identity/wallet-security/blob/main/work_items/device_binding.md), assessing proposals against implementation experience from EU research projects [PRIVÉ](https://trustchain.ngi.eu/prive/) and [DOOR](https://gitlab.grnet.gr/essif-lab/infrastructure_3/gioumpitek/DOOR_project_summary).
